...
struct common_params {
    ...
    int32_t lamio_tier_budget  = 0;     // Lamio: RAM budget in MiB for MoE expert tiering (0 = disabled)
    int32_t lamio_expert_k      = 0;     // Lamio: override active experts per token (0 = model default)
